...
const BOOKS = [
  ...
  },
  {
    ...
    longDescription: 'Tu hija se convierte en la princesa mas valiente del reino, enfrentando dragones amigables, explorando castillos encantados y haciendo amigos en el bosque magico. Con ilustraciones deslumbrantes y una historia de valentia, este libro celebrara la fortaleza y la imaginacion de tu pequena.',
  ...
  },
  {
    ...
    longDescription: 'Un viaje épico al espacio donde tu nino/a explora la luna, visita planetas lejanos y hace amigos alienigenas adorables. Con un cohete personalizado y un traje espacial a medida, esta aventura estimula la curiosidad y el amor por la ciencia.',
  ...
  },
  {
    ...
    longDescription: 'Tu nino/a se adentra en un bosque magico lleno de luciernagas, donde hace amigos con osos simpaticos, conejos curiosos y búhos sabios. Aprende sobre la naturaleza mientras vive una aventura inolvidable en cada pagina.',
    cover: '/covers/bosque.jpg',
    price: '$19.99',
    color: 'from-green-400 via-emerald-500 to-teal-600',
    pages: '24 paginas',
    features: ['Nombre del explorador', 'Animal favorito', 'Estacion del ano', 'Arbol magico personalizado'],
  },
  {
    id: 'colores',
    ...
    longDescription: 'Un libro sensorial y visual disenado para los mas pequenos de la casa. Cada pagina presenta un color diferente con animales adorables, texturas tactiles y elementos interactivos. Perfecto para estimular el desarrollo visual y cognitivo desde los primeros meses.',
    cover: '/covers/colores.jpg',
    price: '$14.99',
    color: 'from-yellow-400 via-orange-500 to-red-500',
    pages: '16 paginas',
    features: ['Texto suave al tacto', 'Animales por color', 'Ilustraciones brillantes', 'Ideal 0-3 anos'],
  },
  {
    id: 'receta',
    ...
    longDescription: 'Tu nino/a se convierte en el chef mas famoso del mundo, creando recetas magicas que danzan en el aire. Con ingredientes coloridos y recetas divertidas, este libro inspira el amor por la cocina y la comida saludable mientras se divierte con cada pagina.',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl p-6 border-2 border-pink-200 shadow-lg shadow-pink-100/40">
              ...
              <p className="text-sm text-gray-500 mb-4">Escribe el nombre de tu nino/a para la portada</p>
              <input
                type="text"
                value={childName}
            ...
            <div className="bg-gradient-to-r from-pink-500 via-rose-500 to-purple-500 rounded-2xl p-6 text-white shadow-xl shadow-pink-300/30">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="bg-white/20 rounded-xl px-4 py-2">
                  <p className="text-xs text-white/80">Envio mundial</p>
                  <p className="text-sm font-bold">Incluido</p>
                </div>
              </div>
              <a
