    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/5" style={{ background: 'rgba(0,0,0,0.8)', backdropFilter: 'blur(20px)' }}>
        <div className="max-w-6xl mx-auto px-5 py-4 flex items-center justify-between">
          ...
          <a
            href="https://wa.me/583026456024?text=Hola,%20estoy%20interesado%20en%20TraccionWeb%20App"
            target="_blank"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {PRICING.map((plan, i) => (
              ...
              >
                ...
                <a
                  href={`https://wa.me/583026456024?text=Hola,%20estoy%20interesado%20en%20el%20plan%20${plan.name}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className={cn(
      ...
      <section className="py-20 px-5">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <a
              href="https://wa.me/583026456024?text=Hola,%20quiero%20una%20demo%20de%20TraccionWeb%20App"
              target="_blank"
              rel="noopener noreferrer"
